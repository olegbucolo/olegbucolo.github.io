...
// work p_07
const work_p_07_IT = "Deliziati con il nostro Template Ristorante - un banchetto visivo progettato per mostrare le tue delizie culinarie, i menu e le opzioni di prenotazione. Lascia un'impressione indimenticabile sui cultori del buon cibo e trasforma i visitatori occasionali in avidi commensali.";

// work p_08
const work_p_08_IT = "Eleva la tua arte con il nostro Template Portfolio - una piattaforma artistica per mostrare i tuoi progetti, le tue abilità e la tua storia. Affascina clienti, collaboratori e ammiratori allo stesso modo mentre lasci il tuo segno creativo.";

// work p_09
const work_p_09_IT = "Trasforma la tua attività con la nostra Pagina Vetrina - un mercato online creato per uno shopping senza soluzione di continuità. Mostra i tuoi prodotti, agevola i clienti con una navigazione semplice e sblocca il potenziale del commercio digitale.";
...
const target_home_header_01_IT = document.querySelector(".nav-link-work");
target_home_header_01_IT.innerHTML = home_header_01_IT;

const target_home_header_02_IT = document.querySelector(".nav-link-about");
